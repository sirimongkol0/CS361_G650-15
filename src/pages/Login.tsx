...
import { Eye, EyeOff, ArrowRight, Building2, Users, FileText, GraduationCap, ChevronDown, Shield, Globe } from "lucide-react";
import { ROLES, UserRole, getRoleConfig } from "../context/RoleContext";
    ...
    <div className="min-h-screen flex" style={{ background: "#F7F8FA" }}>
      ...
      >
        ...
        >
          ...
          <span>
            <span className="font-bold">Prototype Mode:</span> เลือกประเภทผู้ใช้งานเพื่อดู Dashboard
            ตามสิทธิ์ของแต่ละ Role — ในระบบจริง Role ถูกกำหนดจาก Authentication ระบบ
          </span>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <select
                className="input pr-10 font-medium appearance-none"
                value={selectedRole}
            ...
            {selectedRole && (
              <div className="mt-2 flex items-center gap-1.5">
                <span
                  ...
                  style={{
                    color: getRoleConfig(selectedRole).pillColor,
                    background: getRoleConfig(selectedRole).pillBg,
                  }}
                >
          ...
          <div className="flex items-center justify-between">
            ...
            <button type="button" className="text-sm font-semibold" style={{ color: "#8B1538" }}>
              ลืมรหัสผ่าน?
            </button>
          </div>
      ...
      {/* ── Right: Illustration ──────────────────────── */}
      <div
        className="hidden lg:flex flex-1 relative flex-col items-center justify-center p-14"
      ...
      >
        ...
        <div className="relative z-10 max-w-sm w-full">
          ...
          <div className="mb-8">
            ...
            >
              ระบบบริหารความร่วมมือ<br />และ Stakeholder
            </h2>
          ...
          {/* Role preview chips */}
          <div>
            <div className="text-xs font-semibold mb-2.5" style={{ color: "#6B7280" }}>
